							    ...
							    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo anchor('disposisi-internal/print/'.$row->id_disposisi_internal,'<button class="btn btn-success"><i class="fa fa-print"></i> Print</button>',array('target','_BLANK'));?> 
                                            <button class="btn btn-warning" onclick="edit_supplier(<?php echo $row->id_disposisi_internal;?>)"><i class="fa fa-edit"></i> Ubah</button>
                                            <?php echo anchor('disposisi-internal/destroy/'.$row->id_disposisi_internal,'<button class="btn btn-danger"><i class="fa fa-trash"></i> Hapus </button>');?>
                                        </td>
							        </tr>
							        <?php } ?>   
							    </tbody>
...
<script>
    ...
    function edit_supplier(id)
    {
      ...
      $.ajax({
        url : "<?php echo base_url('disposisi-internal/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-footer').show();
            $('#form').attr('action','<?php echo site_url('disposisi-internal/update');?>');
        },
