                                    ...
                                    <tr>
                                       ...
                                       <?php if($jenis == "Keluar"){ ?>
                                        ...
                                        <?php } ?>    
							             ...
							             <?php if($jenis == 'Keluar'){ ?>
							                 <td>
                                                <button class="btn btn-warning" onclick="edit_supplier(<?php echo $row->id_surat_internal;?>)"><i class="fa fa-edit"></i> Edit</button> 
...
<script>
    ...
    function add_supplier(){
        ...
        $('#form').attr({'action':'<?php echo site_url('surat-internal/create');?>','enctype' :'multipart/form-data'});
        $('.modal-footer').show();
    }
