			                ...
			                <div class="panel-body">
                                <blockquote>
                                    <h6>
                                            ...
                                            <b>Asal:</b>  <?php echo $row_surat->nama_pegawai;?> (<?php echo $row_surat->nama_jabatan;?> - <?php echo $row_surat->nama_unit;?>)<br/>
							...
							<table class="display" id="data">
							    ...
							    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor('disposisi_internal/print/'.$row->id_disposisi_internal,'<button class="btn btn-warning"><i class="fa fa-print"></i> Print</button>',array('target','_BLANK'));?>
                                            <button class="btn btn-success" onclick="edit_supplier(<?php echo $row->id_disposisi_internal;?>)"><i class="fa fa-edit"></i> Ubah</button>
                                          
                                            <?php echo anchor('disposisi_internal/destroy/'.$row->id_disposisi_internal,'<button class="btn btn-danger"><i class="fa fa-trash"></i> Hapus </button>');?>
                                        </td>
							        </tr>
							        <?php } ?>   
							    </tbody>
...
<script>
    ...
    function add_supplier(){
        ...
        $('#form').attr('action','<?php echo site_url('disposisi_internal/create');?>');
        $('.modal-footer').show();
    }
    ...
    function edit_supplier(id)
    {
      ...
      $.ajax({
        url : "<?php echo base_url('disposisi_internal/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-footer').show();
            $('#form').attr('action','<?php echo site_url('disposisi_internal/update');?>');
        },
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open('disposisi_internal/create',array('id' => 'form'));?>
       
          <div class="row">
              <div class="col-md-6">
                 <input type="hidden" name="id_disposisi_internal" />
                  <input type="hidden" name="id_surat_internal" value="<?php echo $id_surat_internal;?>"/>
