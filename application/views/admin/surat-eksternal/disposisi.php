							    ...
							    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo anchor('disposisi_eksternal/print/'.$row->id_disposisi_eksternal,'<button class="btn btn-warning"><i class="fa fa-print"></i> Print</button>',array('target','_BLANK'));?>
                                            <button class="btn btn-success" onclick="edit_supplier(<?php echo $row->id_disposisi_eksternal;?>)"><i class="fa fa-edit"></i> Ubah</button>
                                            <?php echo anchor('disposisi_eksternal/destroy/'.$row->id_disposisi_eksternal,'<button class="btn btn-danger"><i class="fa fa-trash"></i> Hapus </button>');?>
                                        </td>
							        </tr>
							        <?php } ?>   
							    </tbody>
...
<script>
    ...
    function edit_supplier(id)
    {
      ...
      $.ajax({
        url : "<?php echo base_url('disposisi_eksternal/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-footer').show();
            $('#form').attr('action','<?php echo site_url('disposisi_eksternal/update');?>');
        },
